            ...
            * */
            ...
            actualIssues.forEach { ai ->
                ...
                * */
                ...
                when {
                    team == null -> mailSender.sendMail(DEFAULT_MAIL_SENDER, TEST_MAIL_RECEIVER, "Area was not resolved to team", "Issues ID = ${ai.idReadable}, Area = $area, DevOpsItems = $devOpsItems")
